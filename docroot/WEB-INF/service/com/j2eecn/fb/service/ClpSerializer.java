...
import com.j2eecn.fb.model.FeedBackClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"fb-j2eecn-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "fb-j2eecn-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.j2eecn.fb.model.impl.FeedBackImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.j2eecn.fb.NoSuchFeedBackException")) {
			return new com.j2eecn.fb.NoSuchFeedBackException();
		}
